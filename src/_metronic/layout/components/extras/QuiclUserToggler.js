...
export function QuickUserToggler() {
  ...
  return (<>
        {layoutProps.offcanvas && (<OverlayTrigger
            placement="bottom"
            overlay={<Tooltip id="quick-user-tooltip">Usuario Logueado</Tooltip>}
        >
            ...
            <div className="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2"
              ...
              <>
                ...
                <span className="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">
                  {user?user.USER_VC_NOMBRE:''}
                </span>
                <span className="symbol symbol-35 symbol-light-success">                
                    <span className="symbol-label font-size-h5 font-weight-bold">{user&&user.USER_VC_NOMBRE?user.USER_VC_NOMBRE[0]:''}</span>
                </span>
              </>
            </div>
          </div>
